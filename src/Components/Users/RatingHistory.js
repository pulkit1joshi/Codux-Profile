        ...
        <div>
          <nav className="navbar navbar-expand-sm bg-light navbar-light nav-tabs">
            <ul className="navbar-nav nav-fill mx-auto">
              ...
              <li className="nav-item">
                <Link to={`/user/${this.props.name}/info`} className="nav-link">
                  {" "}
                  Basic{" "}
                </Link>
              </li>
              <li className="nav-item">
                <Link
                  to={`/user/${this.props.name}/ratinghistory`}
              ...
              <li className="nav-item">
                <Link
                  to={`/user/${this.props.name}/submissions`}
                  className="nav-link"
                >
                  {" "}
                  Submissions{" "}
          ...
          <div style={{ padding: "3rem" }}>
            <Graph data={this.getdata()} labels={this.getlabels()} />
              ...
              <table style={{ padding: "3rem" }} class="table">
                <thead>
                  <tr>
                    <th scope="col">#</th>
                    <th
